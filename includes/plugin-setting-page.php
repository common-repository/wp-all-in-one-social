    ...
    <table class="form-table">
      <tr>
        ...
        <td>
          ...
          <input type="text" name="<?php echo WPAIOS_TEXT_DOMAIN;?>[share_text]" id="share_text" placeholder="i.e. Share On" value="<?php if(isset($wpaios_option['share_text'])){ echo $wpaios_option['share_text']; } else{ echo ''; }?>" <?php if($wpaios_option['text_enable'] == '0') echo 'readonly="readonly"';?>>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <div style="display: inline-block;">
          <div class="wpaios-switch">
            <input type="checkbox" name="<?php echo WPAIOS_TEXT_DOMAIN;?>[icon_hover_animation]" <?php 
            if( !empty($wpaios_option['icon_hover_animation']) && $wpaios_option['icon_hover_animation'] == '1' ) echo 'checked="checked"';?> value="1" class="wpaios-toggle wpaios-toggle-round" id="icon_hover_animation">
            <label for="icon_hover_animation" id="switch-button"></label>
          </div>
          <div style="float: right; margin-left:20px;">
            <select name="<?php echo WPAIOS_TEXT_DOMAIN;?>[icon_animation]" <?php 
            if( !empty($wpaios_option['icon_hover_animation']) && $wpaios_option['icon_hover_animation'] != '1' ) echo 'disabled';?> id="icon_animation">
              <option value="icon-zoomin" <?php if( !empty($wpaios_option['icon_animation']) && $wpaios_option['icon_animation'] == 'icon-zoomin' ) echo 'selected="selected"';?>><?php _e( 'ZoomIn Effect', WPAIOS_TEXT_DOMAIN );?></option>
              <option value="icon-rotate" <?php if( !empty($wpaios_option['icon_animation']) && $wpaios_option['icon_animation'] == 'icon-rotate' ) echo 'selected="selected"';?>><?php _e( 'Rotate Effect', WPAIOS_TEXT_DOMAIN );?></option>
              <option value="icon-flip" <?php if( !empty($wpaios_option['icon_animation']) && $wpaios_option['icon_animation'] == 'icon-flip' ) echo 'selected="selected"';?>><?php _e( 'Flip Effect', WPAIOS_TEXT_DOMAIN );?></option>
          </select>
          </div>
          </div>
        </td>
      ...
      <tr>
        ...
        <td>
          <div class="wpaios-change-icon-order"><?php
            ...
            if( empty( $wpaios_icon_order ) ) $wpaios_icon_order = array('wpaios-email','wpaios-facebook','wpaios-twitter','wpaios-reddit','wpaios-pinterest','wpaios-linkedin','wpaios-whatsapp');
