  ...
  **/
  public function wpaios_setDefault_values(){
    $default_values = array(
      'text_enable' => '0',
      'social_icons' => array('email','facebook','twitter','reddit','pinterest','linkedin','whatsapp'),
      'icon_size' => 'medium',
      'icon_type' => 'square',
    ...
    $default_order = array('wpaios-email','wpaios-facebook','wpaios-twitter','wpaios-reddit','wpaios-pinterest','wpaios-linkedin','wpaios-whatsapp');
